...
@Component({
  ...
  host: {
    class:
      'rounded-xl bg-[#090c2f] shadow-lg shadow-[#FFFFFF08] transition duration-300 ease-in-out transform hover:scale-[1.03] hover:border border-sky-500/50 overflow-hidden',
